...
# verify
lbl_verify = Label(master=frm_form, text='Verify:')
lbl_verify.grid(row=23, column=0, padx=5, pady=5, sticky="w")
btn_verifyEmbedded = Button(master=frm_form, text='Verify Embedded Digisign', width=40, command=computeKey)
btn_verifyEmbedded.grid(row=24, column=1, padx=5, pady=5, sticky='w')
btn_verify = Button(master=frm_form, text='Verify Digisign', width=40, command=computeKey)
btn_verify.grid(row=25, column=1, padx=5, pady=5, sticky='w')
